		...
		return { //this:ActionBasciFsm
				...
				state("waitingForCMD") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t046",targetState="handleSetLed",cond=whenDispatch("setLed"))
				}	 
				...
				state("blinkOn") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t047",targetState="blinkOff",cond=whenTimeout("local_tout_leds_blinkOn"))   
				}	 
				...
				state("needBlinkAgain") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t048",targetState="blinkOn",cond=whenTimeout("local_tout_leds_needBlinkAgain"))   
				}	 
			}
		}
}
