		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t027",targetState="doNotifyAll",cond=whenTimeout("local_tout_realforntsonar_s0"))   
				}	 
				state("doNotifyAll") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t128",targetState="doNotifyAll",cond=whenTimeout("local_tout_realforntsonar_doNotifyAll"))   
				}	 
			}
		}
}
