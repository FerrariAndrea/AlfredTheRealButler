		...
		return { //this:ActionBasciFsm
				...
				state("calibration") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t045",targetState="handleCompass",cond=whenDispatch("compassReq"))
				}	 
				state("handleCompass") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t146",targetState="handleCompass",cond=whenDispatch("compassReq"))
				}	 
			}
		}
}
