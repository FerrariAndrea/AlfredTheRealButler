		...
		return { //this:ActionBasciFsm
				...
				state("calibration") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t043",targetState="handleCompass",cond=whenDispatch("compassReq"))
				}	 
				state("handleCompass") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t144",targetState="handleCompass",cond=whenDispatch("compassReq"))
				}	 
			}
		}
}
