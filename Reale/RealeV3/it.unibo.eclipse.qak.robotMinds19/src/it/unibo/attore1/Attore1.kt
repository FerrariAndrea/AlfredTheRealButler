		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t020",targetState="doNotifyAll",cond=whenTimeout("local_tout_attore1_s0"))   
				}	 
				state("doNotifyAll") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t021",targetState="doNotifyAll",cond=whenTimeout("local_tout_attore1_doNotifyAll"))   
				}	 
			}
		}
}
