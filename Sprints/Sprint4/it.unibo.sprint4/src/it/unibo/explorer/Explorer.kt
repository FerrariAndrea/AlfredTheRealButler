		...
		return { //this:ActionBasciFsm
				...
				state("ready") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t011",targetState="goToPosition",cond=whenEvent("goTo"))
				}	 
				...
				state("doTheMove") { //this:State
					...
					transition(edgeName="t013",targetState="endOfJobFail",cond=whenDispatch("stepFail"))
					transition(edgeName="t014",targetState="handleStepOk",cond=whenDispatch("rotationOk"))
				}	 
				...
				state("rotateSouth") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t015",targetState="checkSouth",cond=whenDispatch("rotationOk"))
				}	 
