...
class Planex1 ( name: String, scope: CoroutineScope ) : ActorBasicFsm( name, scope){
	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("detectBoundary") { //this:State
					...
					transition( edgeName="goto",targetState="boundaryFond", cond=doswitchGuarded({! (NumStep<5)}) )
				}	 
