...
public class DistanceMonitor {
    ...
    protected final static float SOUND_SPEED = 340.29f;  // speed of sound in m/s
    
    protected final static int TRIG_DURATION_IN_MICROS = 10; // trigger duration of 10 micro s
    protected final static int WAIT_DURATION_IN_MILLIS = 60; // wait 60 milli s

    protected final static int TIMEOUT = 10000;//2100
    
    protected final static GpioController gpio = GpioFactory.getInstance();
    
    protected final GpioPinDigitalInput echoPin;
    protected final GpioPinDigitalOutput trigPin;
