...
//Di sopra ancora le vecchie funzioni meno dinamiche
app.post("/addFood1", function (req, res, next) {var quantity=req.body.quantityPIZZA; superHandlePostMove("addFood1-"+quantity, "adding food "+quantity, req, res, next); });
app.post("/addFood2", function (req, res, next) {var quantity=req.body.quantityCRESCENTINA; superHandlePostMove("addFood1-"+quantity, "adding food "+quantity, req, res, next); });
